...
Fill only real gaps. Link existing approval records instead of recreating them.
Unanswered fields remain unknown with a proposed owner and evidence request.
Proposed owners are not accepted owners.
...
3. Compare Linear issues with integration evidence and receiving-team acceptance.
